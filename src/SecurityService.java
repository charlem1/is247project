...
public class SecurityService {
   ...
   public void validateAge(com.club.service.Member m) throws com.club.service.AgeRestrictionException {
      if (m.age < 21) {
         throw new com.club.service.AgeRestrictionException("Must be 21+.");
      }
